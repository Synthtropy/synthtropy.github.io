...
- Audio Units support (virtual instruments and effects)
- GPU-accelerated particle systems and SDF shaders
- DMX512 and Bluetooth light control

---

## Status

Public beta planned for **Q2 2025** via TestFlight (iOS/macOS).  
Full release targeted for **H2 2025**.

This is a teaser preview — features are actively evolving.

---

## Follow the progress

- [TikTok](https://tiktok.com/@...) — dev videos and demos
- [TestFlight signup](#) — get notified when beta opens
